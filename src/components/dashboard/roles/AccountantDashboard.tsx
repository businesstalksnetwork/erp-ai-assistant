...
import { DollarSign, TrendingUp, TrendingDown, Wallet, FileText, Calculator, AlertCircle, Download, ClipboardCheck, Sparkles } from "lucide-react";
      ...
      <div className="grid gap-3 grid-cols-1 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-2.5">
            ...
            {draftCount === 0 && overdueCount === 0 && <p className="text-muted-foreground text-sm">{t("noPendingActions")}</p>}
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-3">
