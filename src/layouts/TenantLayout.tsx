...
const inventoryNav: NavItem[] = [
  ...
  { key: "wmsWavePlanning", url: "/inventory/wms/wave-planning", icon: Layers, aiModule: "ai-wms" },
  { key: "wmsRouteOptimization", url: "/inventory/wms/route-optimization", icon: MapPin, aiModule: "ai-wms" },
  { key: "wmsDemandPutaway", url: "/inventory/wms/demand-putaway", icon: Download, aiModule: "ai-wms" },
  { key: "wmsAnalytics", url: "/inventory/wms/analytics", icon: BarChart3, aiModule: "ai-wms" },
...
const loyaltyNav: NavItem[] = [
  { key: "loyaltyDashboard", url: "/loyalty", icon: LayoutDashboard, section: "loyaltyOverview" },
  { key: "loyaltyPrograms", url: "/loyalty/programs", icon: Settings },
  { key: "loyaltyMembers", url: "/loyalty/members", icon: Users },
