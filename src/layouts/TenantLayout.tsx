...
const accountingNav: NavItem[] = [
  ...
  { key: "costCenterPL", url: "/accounting/cost-center-pl", icon: BarChart3 },
  ...
  { key: "consolidatedStatements", url: "/accounting/consolidated", icon: Layers },
  ...
  { key: "multiPeriodReports", url: "/accounting/multi-period", icon: BarChart3 },
...
const hrNav: NavItem[] = [
  ...
  { key: "pppdReview", url: "/hr/pppd-review", icon: FileSpreadsheet },
